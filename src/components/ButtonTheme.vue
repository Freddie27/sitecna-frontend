...
<template>
  <button
    ...
    class="p-3 bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] text-white rounded-full shadow-lg hover:scale-105 transition-all duration-300 ease-in-out focus:outline-none transition-opacity duration-500"
